...
let int2str(i0: int): string = 
  ...
  if i = 0 then chr (48+(i0 mod 10)) else getDigit(i-1)(i0/10)   (*when i = 0, return the char of the current ones digit, else call the function again with one less digit in i0*) in
  ...
  if i0 < 10 then 1 else 1 + intLength(i0 / 10)   (*if at the ones digit, return *) in 
